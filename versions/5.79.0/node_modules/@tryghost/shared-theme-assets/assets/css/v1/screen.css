...
.gh-head-logo {
    position: absolute;
    bottom: 10px; /* Adjust as needed to place at the bottom of the header */
    left: 50%;
    transform: translateX(-50%);
    font-size: 2.4rem; /* Or whatever size you prefer */
    font-weight: 700;
    letter-spacing: -0.02em;
    width: 100%; /* Ensure the text is centered in the header */
